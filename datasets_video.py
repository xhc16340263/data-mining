...
ROOT_DATASET = '/data3/chenriquan/group2/dataset/something-something-v1'
...
def return_something(modality):
    ...
    if modality == 'RGB':
        root_data = '/data3/chenriquan/group2/dataset/something-something-v1/20bn-something-something-v1'
        ...
        root_data = '/data3/chenriquan/group2/dataset/something-something-v1/flow-2/flow'
        #root_data = '/mnt/localssd1/bzhou/something/flow'
        filename_imglist_train = 'flow-2/train_videofolder.txt'
        filename_imglist_val = 'flow-2/val_videofolder.txt'
        prefix = '{:05d}.jpg'
    else:
